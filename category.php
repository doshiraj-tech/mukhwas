...
$products = mysqli_query(
    $conn,
    "SELECT p.* FROM products p JOIN product_categories pc ON p.id = pc.product_id
...
<head>
    ...
    <meta name="description" content="Browse our fine selection of <?php echo htmlspecialchars($category['category_name']); ?>. Handcrafted traditional Indian mouth fresheners.">
    <title><?php echo htmlspecialchars($category['category_name']); ?> - Raj Kathiyawadi Mukhwash</title>
...
<section class="subpage-banner text-center py-5 mb-5">
    <div class="container py-3">
        <h1 class="display-4 fw-bold text-white mb-2"><?php echo htmlspecialchars($category['category_name']); ?></h1>
        <p class="text-white-50 fs-5 mb-0">Explore our premium selection of <?php echo htmlspecialchars($category['category_name']); ?></p>
    </div>
</section>
    ...
    <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                <div class="card product-card h-100 border-0 shadow-sm">
                    <div class="position-relative overflow-hidden">
                        <img id="catImg-<?php echo $row['id']; ?>" src="assets/uploads/<?php echo $row['image']; ?>" class="card-img-top" alt="<?php echo htmlspecialchars($row['name']); ?>">
                    ...
                    <div class="card-body d-flex flex-column p-4">
                        ...
                        <div class="d-grid gap-2 mt-auto">
                            ...
                            <div class="d-flex gap-2">
                                <button type="button" class="btn btn-primary btn-add-to-cart flex-grow-1 py-2 rounded-pill" style="font-size: 0.85rem;" onclick="addToCartWithFly(document.getElementById('catImg-<?php echo $row['id']; ?>'), <?php echo $row['id']; ?>, this, 'cart/add.php')">
        ...
        ?>
            <div class="col-12 text-center py-5">
                ...
                <h4 class="mt-3 fw-bold">No Products Available</h4>
                <p class="text-muted">There are no products in this category at the moment.</p>
                <a href="shop.php" class="btn btn-primary rounded-pill px-4 py-2 mt-3">Browse Other Items</a>
            </div>
        <?php
        }
        ?>
