...
<head>
    ...
    <meta name="description" content="Search results for '<?php echo htmlspecialchars($keyword); ?>' at Raj Kathiyawadi Mukhwash. Premium quality mouth fresheners.">
    <title>Search Results - Raj Kathiyawadi Mukhwash</title>
...
<section class="subpage-banner text-center py-5 mb-5">
    <div class="container py-3">
        <h1 class="display-4 fw-bold text-white mb-2">Search Results</h1>
        <p class="text-white-50 fs-5 mb-0">Showing matches for "<?php echo htmlspecialchars($keyword); ?>"</p>
    </div>
</section>
    ...
    <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                <div class="card product-card h-100 border-0 shadow-sm">
                    <div class="position-relative overflow-hidden">
                        <img src="assets/uploads/<?php echo $row['image']; ?>" class="card-img-top" alt="<?php echo htmlspecialchars($row['name']); ?>">
                    ...
                    <div class="card-body d-flex flex-column p-4">
                        ...
                        <div class="d-grid gap-2 mt-auto">
                            ...
                            <div class="d-flex gap-2">
                                <button type="button" class="btn btn-primary btn-add-to-cart flex-grow-1 py-2 rounded-pill" style="font-size: 0.85rem;" onclick="addToCartWithFly(document.getElementById('searchImg-<?php echo $row['id']; ?>'), <?php echo $row['id']; ?>, this, 'cart/add.php')">
        ...
        ?>
            <div class="col-12 text-center py-5">
                ...
                <p class="text-muted">We couldn't find any products matching "<strong><?php echo htmlspecialchars($keyword); ?></strong>".</p>
                <a href="shop.php" class="btn btn-primary rounded-pill px-4 py-2 mt-3">Reset Search & Browse</a>
            </div>
        <?php
        }
        ?>
